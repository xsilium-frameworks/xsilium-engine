...
if ("${CEGUI_LIBRARY_OPTIMIZED}" STREQUAL "CEGUI_LIBRARY_OPTIMIZED-NOTFOUND")
set(CEGUI_LIBRARY_OPTIMIZED "")
endif()

if ("${CEGUI_OGRE_RENDERER_LIBRARY_OPTIMIZED}" STREQUAL "CEGUI_OGRE_RENDERER_LIBRARY_OPTIMIZED-NOTFOUND")
set(CEGUI_OGRE_RENDERER_LIBRARY_OPTIMIZED "")
endif()
...
GET_FILENAME_COMPONENT(CEGUI_INCLUDE_DIR "${CEGUI_INCLUDE_DIR}" PATH)
