...
IF (NOT _macroLogFeatureAlreadyIncluded)
   SET(_file ${XSILIUM_BINARY_DIR}/MissingRequirements.txt)
   IF (EXISTS ${_file})
      FILE(REMOVE ${_file})
   ENDIF (EXISTS ${_file})

   SET(_file ${XSILIUM_BINARY_DIR}/EnabledFeatures.txt)
   IF (EXISTS ${_file})
      FILE(REMOVE ${_file})
   ENDIF (EXISTS ${_file})

   SET(_file ${XSILIUM_BINARY_DIR}/DisabledFeatures.txt)
   IF (EXISTS ${_file})
      FILE(REMOVE ${_file})
  ENDIF (EXISTS ${_file})
...
MACRO(MACRO_LOG_FEATURE _var _package _description _url ) # _required _minvers _comments)
   ...
   IF (${_var})
     SET(_LOGFILENAME ${XSILIUM_BINARY_DIR}/EnabledFeatures.txt)
   ELSE (${_var})
     IF (${_required} MATCHES "[Tt][Rr][Uu][Ee]")
       SET(_LOGFILENAME ${XSILIUM_BINARY_DIR}/MissingRequirements.txt)
     ELSE (${_required} MATCHES "[Tt][Rr][Uu][Ee]")
       SET(_LOGFILENAME ${XSILIUM_BINARY_DIR}/DisabledFeatures.txt)
