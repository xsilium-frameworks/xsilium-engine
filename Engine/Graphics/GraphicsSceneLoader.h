 ...
 *
 *  Created on: \date 6 ao�t 2014
 *      Author: \author joda
 *  \brief :
 */
#ifndef GRAPHICSSCENELOADER_H_
#define GRAPHICSSCENELOADER_H_
 ...
 */
  ...
  *
  */
 class GraphicsSceneLoader {
 public:
	 GraphicsSceneLoader();
	 virtual ~GraphicsSceneLoader();
