/*
 * \file PhysicsDynamicRenderable.cpp
 *
...
PhysicsDynamicRenderable::PhysicsDynamicRenderable() {
...
void PhysicsDynamicRenderable::initialize(Ogre::RenderOperation::OperationType operationType,
		bool useIndices)
{
...
//------------------------------------------------------------------------------------------------
void PhysicsDynamicRenderable::prepareHardwareBuffers(size_t vertexCount,
		size_t indexCount)
{
...
//------------------------------------------------------------------------------------------------
Ogre::Real PhysicsDynamicRenderable::getBoundingRadius(void) const
{
	return Ogre::Math::Sqrt(std::max(mBox.getMaximum().squaredLength(), mBox.getMinimum().squaredLength()));
}
//------------------------------------------------------------------------------------------------
Ogre::Real PhysicsDynamicRenderable::getSquaredViewDepth(const Ogre::Camera* cam) const
{
