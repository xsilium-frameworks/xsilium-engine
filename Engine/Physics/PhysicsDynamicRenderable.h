/*
 * \file PhysicsDynamicRenderable.h
 *
 *  Created on: \date 9 janv. 2015
 *      Author: \author joda
 *  \brief :
 */
#ifndef ENGINE_PHYSICS_PHYSICSDYNAMICRENDERABLE_H_
#define ENGINE_PHYSICS_PHYSICSDYNAMICRENDERABLE_H_
 ...
 *
 */
class PhysicsDynamicRenderable : public Ogre::SimpleRenderable {
public:
	PhysicsDynamicRenderable();
	virtual ~PhysicsDynamicRenderable();
...
#endif /* ENGINE_PHYSICS_PHYSICSDYNAMICRENDERABLE_H_ */
