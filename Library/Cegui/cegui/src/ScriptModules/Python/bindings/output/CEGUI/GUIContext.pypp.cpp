...
struct GUIContext_wrapper : CEGUI::GUIContext, bp::wrapper< CEGUI::GUIContext > {
    ...
    ::CEGUI::Window * getCommonAncestor( ::CEGUI::Window * w1, ::CEGUI::Window * w2 ){
...
void register_GUIContext_class(){
    ...
    { //::CEGUI::GUIContext
        ...
        { //::CEGUI::GUIContext::getCommonAncestor
            ...
            typedef ::CEGUI::Window * ( GUIContext_wrapper::*getCommonAncestor_function_type )( ::CEGUI::Window *,::CEGUI::Window * ) ;
        ...
        { //::CEGUI::GUIContext::updateWindowContainingMouse
            ...
            typedef bool ( ::CEGUI::GUIContext::*updateWindowContainingMouse_function_type )(  ) ;
