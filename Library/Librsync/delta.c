...
extern inline int rs_findmatch(rs_job_t *job, rs_long_t *match_pos, size_t *match_len);
extern inline rs_result rs_appendmatch(rs_job_t *job, rs_long_t match_pos, size_t match_len);
extern inline rs_result rs_appendmiss(rs_job_t *job, size_t miss_len);
extern inline rs_result rs_appendflush(rs_job_t *job);
extern inline rs_result rs_processmatch(rs_job_t *job);
extern inline rs_result rs_processmiss(rs_job_t *job);
