...
void SceneLoader::setupResources(void)
{
...
bool SceneLoader::frameRenderingQueued(const Ogre::FrameEvent& evt)
{
...
void SceneLoader::switchCamera(int idx)
{
...
bool SceneLoader::keyPressed( const OIS::KeyEvent &arg )
{
